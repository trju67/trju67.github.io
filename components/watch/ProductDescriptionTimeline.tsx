...
export default function ProductDescriptionTimeline({
  ...
  return (
    <div className="flex h-full flex-col justify-center py-24 lg:max-w-[520px]">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            >
              {stage.cta ?? 'Request Availability'}
            </button>
            <button
              type="button"
              data-cursor="Add"
      ...
      <div className="mt-14 grid grid-cols-2 gap-x-8 gap-y-5 border-t border-aura-ivory/10 pt-8">
